/**
 * Analytics Service
 * Handles fetching analytics data and creating charts
 */

// Import Chart.js if you're using it directly in your project
// If you're using a CDN, make sure to include the script in your HTML
